...
print("[+] Processing entity files inside ../schemas/entities directory")
# Open OSSEM CDM entity YML file
print("[+] Opening entity YML files..")
entity_files = glob.glob(path.join(path.dirname(__file__), '../schemas/entities', "*.yml"))
...
print("[+] Processing table files inside ../schemas/tables directory")
# Open OSSEM CDM Table YML file
print("[+] Opening table YML files..")
table_files = glob.glob(path.join(path.dirname(__file__), '../schemas/tables', "*.yml"))
